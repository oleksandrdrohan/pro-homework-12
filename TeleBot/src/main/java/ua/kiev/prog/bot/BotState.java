...
public enum BotState {
    ...
    EnterYourWishes{
        ...
        @Override
        public void enter(BotContext context){sendMessage(context, "Enter your wishes: ");}

        @Override
        public void handleInput(BotContext context){
            String wishes = context.getInput();
            context.getUser().setWishes(context.getInput());
        }

        @Override
        public BotState nextState(){return Approved;}
    },
